...
# Set-Location "R:\sandbox\ps-Sandbox"
...
write-host
write-host "  Name of script                : $($myInvocation.myCommand.name)"
write-host "  Located directory             : $psScriptRoot"
write-host "  The path to the script        : $psCommandPath"
